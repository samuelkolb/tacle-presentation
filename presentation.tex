  ...
  {\small\setlength{\tabcolsep}{0.33em}
    \begin{table}[]
      ...
      \begin{tabularx}{\linewidth}{lccccccc}
        ...
        \textbf{\begin{tabular}[c]{@{}l@{}}Relevant\\[-4pt] Constraints\end{tabular}} & 34 & 3.78 & 52 & 2.48 & 6 & 1.50
      \end{tabularx}
    \end{table}
  }
  \end{block}
